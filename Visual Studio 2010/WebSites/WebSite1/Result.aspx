<%@ Page EnableViewStateMac="true" ViewStateEncryptionMode="Always" Language="VB" AutoEventWireup="false" CodeFile="Result.aspx.vb" Inherits="Result" %>
...
<body>
    ...
    <div class="container">
      ...
      <div class="alert alert-danger alert-dismissible fade show" role="alert">
              <strong>Attenzione</strong> <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
            </div>

            <div style="float:none; margin-left:auto; margin-right:auto; text-align:center;">
<asp:Button ID="Button1" runat="server" Text="Torna Indietro" type="button" style="height:50px; width:300px;" class="waves-effect waves-light btn mb-1 btn-primary"></asp:Button>
                  </div>
